...
export default function Engineer() {
  ...
  return (
    <div className='w-full h-full absolute lowercase text-fuchsia-100 text-2xl font-spaceGrotesk'>
      ...
      <div id='txt-3' className='absolute top-[8%] left-[8%]'>
        Backend
      </div>
      ...
      <div id='txt-8' className='absolute top-[19%] left-[10%] text-5xl'>
        <SiKubernetes />
      </div>
      ...
      <div id='txt-11' className='absolute top-[31%] left-[10%] text-5xl'>
        <FaRust />
      </div>
      <div id='txt-12' className='absolute top-[34%] left-[45%]'>
        Cybersecutiry
      </div>
    </div>
  );
